...
export type SchedulerConfigQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type SchedulerConfigQuery = {
  __typename?: 'Query';
  meetingBookingEvents: Array<{
    ...
    bookOptionBufferBetweenMeetingsMins: any;
    bookOptionDaysInAdvance: any;
    bookingFormPhoneRequired: boolean;
    bookOptionMinNoticeMins: any;
    assignmentMethod: Types.MeetingBookingAssignmentMethod;
