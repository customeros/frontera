    ...
    return (
      <>
        ...
        <div className='flex flex-col w-full h-[13rem] items-start gap-2 mt-2 px-1 mx-[-4px] overflow-x-hidden overflow-y-auto'>
          {users.length > 1 && (
            <div className='sticky top-0 w-full z-10 bg-white gap-2 flex flex-col pb-2 border-b border-grayModern-200'>
              <Checkbox
          ...
          {options.length > 0 ? (
            ...
            <div className='flex w-full justify-center items-center flex-col'>
              <Tumbleweed className='size-8 text-grayModern-400' />
