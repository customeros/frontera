    ...
    <div className='mb-20'>
      <div className='sticky top-0 bg-white mb-2'>
        ...
        <div className='flex items-center gap-x-2 px-4'>
          <Icon name={'search-sm'} className='size-4 text-grayModern-500' />
          <Input
            autoFocus
            size='sm'
            type='text'
        ...
        {filteredSections.length > 0 ? (
          filteredSections.map((section, idx) => (
            <div key={idx} className='mb-5'>
              <h3 className='text-sm font-medium text-grayModern-700 mb-2'>
                {section.title}
              </h3>
              {section.shortcuts.map((shortcut, shortcutIdx) => (
                ...
                >
                  <p className='text-grayModern-700'>{shortcut.label}</p>
                  <div className='flex items-center gap-1'>
                    {shortcut?.sequence ? (
                      <div className='flex items-center gap-1'>
                        <kbd className='px-2 py-1 bg-grayModern-100 rounded text-xs'>
                          {shortcut.sequence[0]}
                        </kbd>
          ...
          <div className='text-center text-sm text-grayModern-500 mt-4'>
