...
export const SidenavItem = ({
  ...
  return (
    <Button
      ...
      className={`w-full justify-start px-3 text-grayModern-700 hover:bg-grayModern-100 *:hover:text-grayModern-700 focus:shadow-sidenavItemFocus mb-[2px] ${dynamicClasses}`}
    >
