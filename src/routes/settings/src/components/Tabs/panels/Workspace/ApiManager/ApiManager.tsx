...
export const ApiManager = observer(() => {
  ...
  return (
    <article className='px-6 pb-4 max-w-[500px] h-full overflow-y-auto  border-r border-grayModern-200'>
      <div className='flex flex-col '>
        <div className='flex justify-between items-center pt-2 sticky top-0 bg-grayModern-25 '>
          <h1 className='text-grayModern-700 font-semibold text-base'>API</h1>
        </div>
      ...
      <div
        ...
        className='py-1 min-h-[32px] max-h-[32px] mb-1 border text-sm rounded-md border-grayModern-200 flex justify-between items-center'
      >
